...
<div class="services">
        ...
        ?>
            <div class="services-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                <div class="services-item-flex"><img class="services-item__img" src="<?echo $arItem['DISPLAY_PROPERTIES']['FILES']['FILE_VALUE']['SRC']?>">
                    <div class="services-item__title"><?echo $arItem["NAME"]?></div>
                    <div class="services-item__price">
                        <?if($arItem["PROPERTIES"]['FROM']['VALUE'] != ''):?>от<span><i><?echo $arItem["PROPERTIES"]['PRICE']['VALUE']?></i></span>руб.</div>
                        <?else:?>
